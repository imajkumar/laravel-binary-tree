...
class InstallCommand extends Command
{
   ...
   * @var string
   */
  protected $description = 'Scaffolds a new migration and model suitable for Ayra.';

  /**
   * Migration generator instance.
   *
   * @var Ayra\Generators\MigrationGenerator
   */
  protected $migrator;
   ...
   *
   * @var Ayra\Generators\ModelGenerator
   */
  protected $modeler;
